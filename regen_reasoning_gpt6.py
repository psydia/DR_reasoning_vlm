...
ROOT = "/dme_vqa"
SPLIT = "val"
DATA_PATH = os.path.join(ROOT, f"bad_{SPLIT}_samples_for_regen.json")
IMG_ROOT = os.path.join(ROOT, "visual", SPLIT)
OUTPUT_DIR = "/dme_vqa"
OUT_PATH = os.path.join(OUTPUT_DIR, f"bad_{SPLIT}_reasoning_samples_regenerated.json")
...
If the question references a specific anatomical region (e.g., "top-left region", "center"), explicitly focus your observation and interpretation on that region while still considering the global context of the eye. The ground truth answers are correct.
